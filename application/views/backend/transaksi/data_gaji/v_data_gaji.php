                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success mb-1"
                                                    data-url="<?= base_url() ?>">Cetak</button>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                        ...
                        <nav>
                            <ul class="pagination justify-content-center">
                                <li class="page-item <?= ($current_page == 1) ? 'disabled' : '' ?>">
                                    <a class="page-link"
                                        href="<?= base_url('C_Data_Gaji/data_gaji/index?page=' . ($current_page - 1)) ?>">Previous</a>
                                </li>
                                <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                <li class="page-item <?= ($current_page == $i) ? 'active' : '' ?>">
                                    <a class="page-link"
                                        href="<?= base_url('C_Data_Gaji/data_gaji/index?page=' . $i) ?>">
                                        <?= $i ?>
                                    </a>
                                </li>
                                <?php } ?>
                                <li class="page-item <?= ($current_page == $total_pages) ? 'disabled' : '' ?>">
                                    <a class="page-link"
                                        href="<?= base_url('C_Data_Gaji/data_gaji/index?page=' . ($current_page + 1)) ?>">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
